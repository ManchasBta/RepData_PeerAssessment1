...
number_NA
```
The number of missing values was calculated to be `r number_NA`. Those missing values were replace, by using the most common number of steps taken during a 5 minutes interval. Assuming the most likely value for the missing data is at large the most frequent number of steps taken across the 2 months of study.
